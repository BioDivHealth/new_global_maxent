...
ad1<-list.files("C:/Users/david.redding/Documents/datasets1/",pattern="all_data3",full.names=TRUE)
ad2<-list.files("C:/Users/david.redding/Documents/datasets1/",pattern="all_data3",full.names=FALSE)
