...
for(qq in ord1){
  ...
  for (i in i:length(names2)){
    ...
    if(paste("C:\\Users\\david.redding\\Documents\\more_results2\\per_disease_results_",names2[i],"_",typex,".tif",sep="") %in% list.files("C:\\Users\\david.redding\\Documents\\more_results2\\",full.names = TRUE)){next}
   ...
   writeRaster(rast1,format="GTiff",file=paste("C:\\Users\\david.redding\\Documents\\more_results2\\per_disease_results_",names2[i],"_",typex,".csv",sep=""))
