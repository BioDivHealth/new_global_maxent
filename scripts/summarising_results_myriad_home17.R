...
#for (j in j:2){
  ...
  for (k in sss){
    ...
    ##indivdual results
    df4<-rbind(df1,df3)
    write.csv(df4,file=paste("C:\\Users\\david.redding\\Documents\\more_results\\per_disease_results","_",sample(1e7,1),typex,".csv",sep=""))
...
for (i in 1:length(names2)){
  ...
  writeRaster(rast1,format="GTiff",file=paste("C:\\Users\\david.redding\\Documents\\more_results\\",names2[i],"_",sample(1e7,1),"_",typex,".tif",sep=""))
