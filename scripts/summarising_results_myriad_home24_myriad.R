...
combs3<-paste(combs2[,2],combs2[,1],sep="_")
  ...
  for (j in samps2){
   ...
   #done2$uni<-paste(done2$V4,done2$V5,done2$V6,sep="_")
    ...
    resF[,c("SSP1","SSP2","SSP3","SSP4","SSP5","PRESENT","i.cell.id","i.cell.id.1","i.year","prop_in_pov","prop_in_pov_futureSSP1","prop_in_pov_futureSSP2","prop_in_pov_futureSSP3","prop_in_pov_futureSSP4","prop_in_pov_futureSSP5"):=NULL]
    ##create dummy
    resF[,dummy:=1]
