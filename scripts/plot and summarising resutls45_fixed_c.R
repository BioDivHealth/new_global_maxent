...
#  hist(temp1$lm1)
 ...
 # r6x[,mean(lm1*abs(cor1)),by=.(Year,Kingdom)]
  ...
  typesX<-c("Baseline","Accuracy","Regional","Vectored","SSP","Burden","Emerging","Hantaviridae","Kingdom","Tropical/Temperate","RCP/SSP","Threshold","KingTrans")
  ...
  ##write to disck
  #write.csv(res7,file="C:\\Users\\david.redding\\Dropbox\\New_Global_MAXENT\\workings23062022.csv")
  res7z<-read.csv(file="C:\\Users\\david.redding\\Dropbox\\New_Global_MAXENT\\workings23062022.csv",stringsAsFactors = F)
  res7z<-res7z[,-1]
