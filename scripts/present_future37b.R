...
for (i in (i+1):length(pres1)){
  ...
  jpeg(file=paste("C:\\Users\\xxxx\\Dropbox\\New_Global_MAXENT\\risk_maps\\",pres2[i],"_",sample(1:1000,1),"HazardT.jpg",sep=""),width=2500,height=1000)
  print(
    ggplot(data = ad1c) +
