...
plot(Emerging_endemic)
plot(Established_endemic)
plot(Endemic_endemic)
plot(Hyperendemic_endemic)

plot(ssp3X8.5_2080XEmerging_future_endemic)
plot(ssp3X8.5_2080XEmerging_future_endemic_increase/ssp3X8.5_2080XEmerging_future_endemic)
plot((-1*ssp3X8.5_2080XEmerging_future_endemic_decrease)/ssp3X8.5_2080XEmerging_future_endemic)

plot(ssp3X8.5_2080XEstablished_future_endemic)
plot(ssp3X8.5_2080XEstablished_future_endemic_increase/ssp3X8.5_2080XEstablished_future_endemic)
plot((-1*ssp3X8.5_2080XEstablished_future_endemic_decrease)/ssp3X8.5_2080XEstablished_future_endemic)

plot(ssp3X8.5_2080XEndemic_future_endemic)
plot(ssp3X8.5_2080XEndemic_future_endemic_increase/ssp3X8.5_2080XEndemic_future_endemic)
plot((-1*ssp3X8.5_2080XEndemic_future_endemic_decrease)/ssp3X8.5_2080XEndemic_future_endemic)
...
for (w in 1:length(names1)){
  ...
  writeRaster(rast1,format="GTiff",file=paste("C:\\Users\\xxxx\\Documents\\more_results\\",gsub(">","",names1[w]),"_",sample(1:1e8,1),"_no_nondisease.tif",sep=""))
