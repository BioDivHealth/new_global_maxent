...
##defaunation surface
#predicts3<-raster("C:\\Users\\david.redding\\Dropbox\\global_IUCN\\data\\final-abund-bii-isl-main.tif")
...
#writeRaster(predicts2b,format="GTiff",file="C:\\Users\\david.redding\\Dropbox\\global_IUCN\\data\\predicts_resampled_template.tif",overwrite=TRUE);gc()
...
#load(file="C:\\Users\\david.redding\\Dropbox\\New_Global_MAXENT\\GINI5.r")
#load(file="C:\\Users\\david.redding\\Dropbox\\New_Global_MAXENT\\GP7.r")
#load(file="C:\\Users\\david.redding\\Dropbox\\New_Global_MAXENT\\GPpres.r")
#load(file="C:\\Users\\david.redding\\Dropbox\\New_Global_MAXENT\\popgdp7.r")
#load(file="C:\\Users\\david.redding\\Dropbox\\New_Global_MAXENT\\popgdp2010b.r")
...
###find all present day
iucn1<-list.files("C:\\Users\\david.redding\\Documents\\disease_host_ranges\\",pattern="3.tif",full.names=TRUE)
iucn2<-list.files("C:\\Users\\david.redding\\Documents\\disease_host_ranges\\",pattern="3.tif",full.names=FALSE)
...
#save(res100,file="C:\\Users\\david.redding\\Dropbox\\New_Global_MAXENT\\res100b.r")
#load("C:\\Users\\david.redding\\Dropbox\\New_Global_MAXENT\\res100d.r")
...
i=d2b[d2b$disease=="menangle","combine"]
...
for (i in sample(nums)){
 # gc()
  ...
  ##remove those with less than 1 per km2
  ...
  #fwrite(res6,file=paste("C:\\Users\\david.redding\\Documents\\datasets1\\",nam_dis,"_",sample(1:1000,1),"_all_data2.csv",sep=""))
  ...
  #cols1<-c("clim_present_mean2","Hazard","HazardT","HazardTD","Hazard_future","Hazard_futureTD","host_range","host_range2","RiskL")
    ...
    ##plot to see where the data are MAdavid.redding
    #plot(wrld_simpl)
    pl1<-ws2
    pl1[pl1==1]<-0
    ...
    pdf(file=paste("C:\\Users\\david.redding\\Documents\\risk_maps2\\",nam_dis,"_",sample(1:1000,1),"all_plots.pdf",sep=""),width=8,height=8)
    ...
    ##
    pdf(file=paste("C:\\Users\\david.redding\\Documents\\results_plots1\\",nam_dis,"_",sample(1:1000,1),"results_plot.pdf",sep=""),width=7,height=5)
  ...
  #res6[,Hazard_future:=Hazard_future_UW * spillover_rate2] ## or without CFR and spill over and divide up into cost groups
    ...
    ##write main data
    fwrite(resF,file=paste("C:\\Users\\david.redding\\Documents\\datasets1\\",nam_dis,"_",sample(1:1000,1),"_all_data3.csv",sep=""))
    
    ##write gain loss
    fwrite(dis_trans2,file=paste("C:\\Users\\david.redding\\Documents\\gainlossresults\\",nam_dis,"_",sample(1:1000,1),"_1.csv",sep=""))
