...
for (i in sample(nums)){
  ...
  if( paste("/home/ucbtdw0/Scratch/New_Global_MAXENT/gainlossresults//",nam_dis,"_1.csv",sep="") %in% list.files("/home/ucbtdw0/Scratch/New_Global_MAXENT/gainlossresults/",full.names=TRUE) ){next}
  ...
  ### not looking at intensity - only way to examine that is through vulnerability (or habitat preference?)
  ### can measure intensity for only 10 or so diseases  
  
  ###create realised present mean - abundance from habitat????
  ...
  #fwrite(res6,file=paste("/home/ucbtdw0/Scratch/New_Global_MAXENT/datasets1/",nam_dis,"_",sample(1:1000,1),"_all_data2.csv",sep=""))
  ...
  #cols1<-c("clim_present_mean2","Hazard","HazardT","HazardTD","Hazard_future","Hazard_futureTD","host_range","host_range2","RiskL")
    ...
    ##
    pdf(file=paste("/home/ucbtdw0/Scratch/New_Global_MAXENT/results_plots1/",nam_dis,"_",sample(1:1000,1),"results_plot.pdf",sep=""),width=7,height=5)
  ...
  #res6[,Hazard_future:=Hazard_future_UW * spillover_rate2] ## or without CFR and spill over and divide up into cost groups
    ...
    ##write main data
    fwrite(resF,file=paste("/home/ucbtdw0/Scratch/New_Global_MAXENT/datasets1/",nam_dis,"_",sample(1:1000,1),"_all_data3.csv",sep=""))
    
    ##write gain loss
    fwrite(dis_trans2,file=paste("/home/ucbtdw0/Scratch/New_Global_MAXENT/gainlossresults/",nam_dis,"_1.csv",sep=""))
