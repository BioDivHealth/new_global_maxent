...
#for (j in j:2){
  ...
  #for (k in sss){
   ...
   #for (qq in 1:1){
      ...
      ##indivdual results
      df4<-rbind(df1,df2)
      write.csv(df4,file=paste("C:\\Users\\david.redding\\Documents\\more_results2\\per_disease_results_",combs2[qq,2],"_",resF$name[1],"_",typex,".csv",sep=""))
