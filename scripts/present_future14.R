...
GP2[,pov_frac_present:= 1-( ((1+value)/(1-value)) * (1/(693.50/(gdp2010/(humans2010*10000)))) )^ ((1+value)/(2*value))]
GP2[,pov_frac_SSP1:= 1-( ((1+value)/(1-value)) * (1/(693.50/(gdp_ssp1/(pop_ssp1*10000)))) )^ ((1+value)/(2*value))]
GP2[,pov_frac_SSP2:= 1-( ((1+value)/(1-value)) * (1/(693.50/(gdp_ssp2/(pop_ssp2*10000)))) )^ ((1+value)/(2*value))]
GP2[,pov_frac_SSP3:= 1-( ((1+value)/(1-value)) * (1/(693.50/(gdp_ssp3/(pop_ssp3*10000)))) )^ ((1+value)/(2*value))]
...
load(file="C:\\Users\\xxxx\\Dropbox\\New_Global_MAXENT\\GP2_gini.r")
