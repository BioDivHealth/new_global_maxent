...
for (xxx in 1:10){  
    ...
    res6x<-res6[ res6$AUC>0.5 & res6$Disease=="Disease" ,]
  ...
  # create loop for maps
     ...
     ##gain
     png(file=paste("C:\\Users\\david.redding\\Dropbox\\New_Global_MAXENT\\future_maps\\AAfuture_gain_",paste(jj,pp,sep="_"),".png",sep=""),width=1000,height=500)
     ...
     ##loss
     png(file=paste("C:\\Users\\david.redding\\Dropbox\\New_Global_MAXENT\\future_maps\\AAfuture_loss_",paste(jj,pp,sep="_"),".png",sep=""),width=1000,height=500)
     ...
     ##net
     png(file=paste("C:\\Users\\david.redding\\Dropbox\\New_Global_MAXENT\\future_maps\\AAfuture_net_",paste(jj,pp,sep="_"),".png",sep=""),width=1000,height=500)
...
plot(mask1,col="#00000010",main=paste(jj,pp,"net change",sep=" "),legend=FALSE)
plot(net2080b,add=TRUE,col=rev(viridis(50,option="C"))[8:50],legend=TRUE)
#plot(countr1,lwd=1,border="olivedrab",add=TRUE)
#if(nrow(pd)>0){points(pd)}
dev.off()
