...
for (j in j:length(ad1)){
  ...
  ##no non diseases
     ...
     #assign(combs$uni[qq],pres_spill)
     if(class(tryCatch(get(paste(typex,"endemic_disease",sep="_")), error=function(err2) err2))[1]=="simpleError"){assign(paste(typex,"endemic_disease",sep="_"),pres4a)} else {assign(paste(typex,"endemic",sep="_"),get(paste(typex,"endemic_disease",sep="_"))+pres4a)}
    ...
    ### humans      
     ...
     #  for (qq in 1){
       ...
       change1<-fut4-pres4
        ...
        #assign(combs$uni[qq],fut_spill)
        if(class(tryCatch(get(paste(combs$uni[qq],"future_endemic_disease",sep="_")), error=function(err2) err2))[1]=="simpleError"){assign(paste(combs$uni[qq],"future_endemic_disease",sep="_"),fut4a)} else {assign(paste(combs$uni[qq],"future_endemic_disease",sep="_"),get(paste(combs$uni[qq],"future_endemic_disease",sep="_"))+fut4a)}
        ...
        if(class(tryCatch(get(paste(combs$uni[qq],"future_endemic_disease_increase",sep="_")), error=function(err2) err2))[1]=="simpleError"){assign(paste(combs$uni[qq],"future_endemic_disease_increase",sep="_"),change1)} else {assign(paste(combs$uni[qq],"future_endemic_disease_increase",sep="_"),get(paste(combs$uni[qq],"future_endemic_disease_increase",sep="_"))+change1)}
        
        if(class(tryCatch(get(paste(combs$uni[qq],"future_endemic_disease_decrease",sep="_")), error=function(err2) err2))[1]=="simpleError"){assign(paste(combs$uni[qq],"future_endemic_disease_decrease",sep="_"),change2)} else {assign(paste(combs$uni[qq],"future_endemic_disease_decrease",sep="_"),get(paste(combs$uni[qq],"future_endemic_disease_decrease",sep="_"))+change2)}
        rm(change1,change2) 
     ...
     rm(fut4,fut4a,fut4b,fut_spill,fut_spill2)
     
     rm(pres,fut)
     
     ls_then<-ls()[!ls() %in% ls_now]
  
     res5<-stack(get(ls_then))
