...
names1<-ls()[c(4:7,26:37,52:259)]

for (w in w:length(names1)){
  
  rast1<-get(names1[w])
  names(rast1)<-names1[w]
  
  writeRaster(rast1,format="GTiff",file=paste("C:\\Users\\xxxx\\Documents\\more_results\\",gsub(">","",names1[w]),"_",sample(1:1e8,1),".tif",sep=""))
