...
res15<-res15[,-c(54:58,60,61,63:65,80),with=F]
res15$year<-as.numeric(res15$year)
...
hist(coefs_area$coef[coefs_area$prob<0.01])
...
hist(coefs_hazard$coef[coefs_hazard$prob<0.01])
...
hist(coefs_risk$coef[coefs_risk$prob<0.01])
