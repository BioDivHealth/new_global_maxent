...
ad1<-list.files("C:/Users/xxxx/Dropbox/New_Global_MAXENT/cellids/",pattern="_2_cellids",full.names=TRUE)
ad2<-list.files("C:/Users/xxxx/Dropbox/New_Global_MAXENT/cellids/",pattern="_2_cellids",full.names=FALSE)
