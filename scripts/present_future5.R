...
save(GP4,file="C:\\Users\\xxxx\\Dropbox\\New_Global_MAXENT\\GP4.r")
...
##write new file
#writeOGR(obj=ad1,dsn="C:\\Users\\xxxx\\Dropbox\\New_Global_MAXENT\\",layer="admin3_POPGDP",driver="ESRI Shapefile")
